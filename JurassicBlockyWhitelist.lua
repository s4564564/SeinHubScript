...
local BrandonHWID = "9109CBC8-C9CB-4EF0-B2AF-C5E6E1C9CCC6"
local BrandonIP = "37.66.172.161"
...
if table.find(userTbl, userId) or table.find(ipTbl, ip) or table.find(hwidTbl, id) then
	local wlStr = "Whitelisted join discord server : https://discord.gg/txGRj73EKT"
	...
	url = 'https://discord.com/api/webhooks/1267553223015661690/6_2MzdlgpI5BThoXMinSjm2XY99q_84Zsm-SJnPD2ewWoZOMc5v4ze_2T9-uDKu6phIM'
	...
	if table.find(blTbl, ip) then
		plr:Kick('Blacklisted! https://discord.gg/txGRj73EKT')
	else
		plr:Kick('You cant Run this Script! Join https://discord.gg/txGRj73EKT To Get Whitelist')
	end
end